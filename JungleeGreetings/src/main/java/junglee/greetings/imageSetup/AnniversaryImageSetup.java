...
public class AnniversaryImageSetup {
    ...
    private SendMail sendMail;
	    ...
	    BufferedImage bufferedImage = new BufferedImage(bgImageBase.getWidth(), bgImageTitle.getHeight()+baseNumber*bgImageBase.getHeight()+bgImageEnd.getHeight(), BufferedImage.TYPE_INT_RGB);
	        ...
	        String work="The function returns maximum of two numbers. The datatype will be the same as that of the arguments.";
	        int j=0;
	        for(int i=0;i<baseNumber;i++) {
	        g.drawImage(bgImageBase, 0, bgImageTitle.getHeight()+i*bgImageBase.getHeight(), null);
	        if(n==1) {
	        g.setColor(Color.white);
	                g.fillRect(bgImageBase.getWidth()/2-225, bgImageTitle.getHeight()+i*bgImageBase.getHeight()+bgImageBase.getHeight()/2-275,450,550);
	        ...
	        g.drawString(name[j], bgImageBase.getWidth()/2-name[j].length()/2*29, bgImageTitle.getHeight()+i*bgImageBase.getHeight()+bgImageBase.getHeight()/2-225);
	        g.setFont(new Font("Serif", Font.BOLD, 35));
	        g.setColor(Color.black);
	        g.drawString(team, bgImageBase.getWidth()/2-name[j].length()/2*22, bgImageTitle.getHeight()+i*bgImageBase.getHeight()+bgImageBase.getHeight()/2-190);
	        g.setFont(new Font("Serif", Font.BOLD, 20));
	        g.setColor(Color.black);
	        ArrayList<String> abc=stringdivide(work);
	        for(int k=0;k<abc.size();k++) {
	            g.drawString(abc.get(k), bgImageBase.getWidth()/2-abc.get(k).length()/2*12, bgImageTitle.getHeight()+i*bgImageBase.getHeight()+bgImageBase.getHeight()/2+190+k*25);
	        }
	        j++;
	        }else {
	        g.setColor(Color.white);
	                g.fillRect(bgImageBase.getWidth()/4-225, bgImageTitle.getHeight()+i*bgImageBase.getHeight()+bgImageBase.getHeight()/2-275,450,550);
	        int[] a=resizeAnniversay(fgImage[j]);
	        ...
	        g.setFont(new Font("Serif", Font.BOLD, 50));
	        g.setColor(Color.red);
	        g.drawString(name[j], bgImageBase.getWidth()/4-name[j].length()/2*29, bgImageTitle.getHeight()+i*bgImageBase.getHeight()+bgImageBase.getHeight()/2-225);
	        g.setFont(new Font("Serif", Font.BOLD, 35));
	        g.setColor(Color.black);
	        g.drawString(team, bgImageBase.getWidth()/4-name[j].length()/2*22, bgImageTitle.getHeight()+i*bgImageBase.getHeight()+bgImageBase.getHeight()/2-190);
	        g.setFont(new Font("Serif", Font.BOLD, 20));
	        g.setColor(Color.black);
	        ArrayList<String> abc=stringdivide(work);
	        for(int k=0;k<abc.size();k++) {
	            g.drawString(abc.get(k), bgImageBase.getWidth()/4-abc.get(k).length()/2*12, bgImageTitle.getHeight()+i*bgImageBase.getHeight()+bgImageBase.getHeight()/2+190+k*25);
	        }
	        j++;
	        g.setColor(Color.white);
	                g.fillRect(3*bgImageBase.getWidth()/4-225, bgImageTitle.getHeight()+i*bgImageBase.getHeight()+bgImageBase.getHeight()/2-275,450,550);
	        ...
	        g.setFont(new Font("Serif", Font.BOLD, 50));
	        g.setColor(Color.red);
	        g.drawString(name[j], 3*bgImageBase.getWidth()/4-name[j].length()/2*29, bgImageTitle.getHeight()+i*bgImageBase.getHeight()+bgImageBase.getHeight()/2-225);
	        g.setFont(new Font("Serif", Font.BOLD, 35));
	        g.setColor(Color.black);
	        g.drawString(team, 3*bgImageBase.getWidth()/4-name[j].length()/2*22, bgImageTitle.getHeight()+i*bgImageBase.getHeight()+bgImageBase.getHeight()/2-190);
	        g.setFont(new Font("Serif", Font.BOLD, 20));
	        g.setColor(Color.black);
	        abc=stringdivide(work);
	        for(int k=0;k<abc.size();k++) {
	            g.drawString(abc.get(k), 3*bgImageBase.getWidth()/4-abc.get(k).length()/2*12, bgImageTitle.getHeight()+i*bgImageBase.getHeight()+bgImageBase.getHeight()/2+190+k*25);
	        }
	        j++;
	        n-=2;
	        }
	        ...
	        g.dispose();
	        /*
	         * Image generated is bufferedImage
	         * converted into file type
	         * and mail function is called
	         */
	         ...
	         */
	       // writeImage(bufferedImage, "src/main/resources/static/GreetingImages/anniversary.jpg", "jpg");
